                ...
                >
                  ...
                  <td className="px-1 py-2">
                    {user.role === "admin" ? (
                      ...
                      <button onClick={() => handleMakeAdmin(user)} className="flex justify-center items-center gap-3">
                        {user.role}<FaUserGraduate className="text-2xl bg-[#ac7e13af] text-white p-1 rounded-md"></FaUserGraduate>
                      </button>
                    )}
                  </td>
